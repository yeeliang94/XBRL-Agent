"""Schema v35 — mtool_fill_receipts (durable record of every mTool fill).
...
file" has to be recorded at fill time or it is unrecoverable. Inert unless
XBRL_MTOOL_FILL is on (plan Step 19, peer-review finding 6).
"""
